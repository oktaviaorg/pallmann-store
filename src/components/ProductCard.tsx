    ...
    >
      ...
      <div className="absolute top-3 left-3 z-10 flex flex-col gap-1">
        {product.category_name && (
          <span className="bg-[#0F172A] text-white px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wide">
            {product.category_name}
          </span>
        )}
      ...
      {/* Product Image */}
      <div className="relative bg-gradient-to-br from-[#F8FAFC] via-white to-[#EFF6FF] p-4 pt-10">
        {product.image_url ? (
          <img
      ...
      <div className="p-4 flex-grow flex flex-col">
        <h3 className="text-sm font-bold text-[#0F172A] mb-1 group-hover:text-[#2563EB] transition-colors line-clamp-2 leading-tight">
          {product.name}
        </h3>
        ...
        {/* Prix - SUPER VISIBLE */}
        {product.price_public_ht && (
          <div className="mb-2 p-2.5 bg-gradient-to-r from-[#EFF6FF] to-[#F5F3FF] rounded-xl border border-blue-100">
            {validatedCode ? (
              <div>
        ...
        {product.pdf_url && (
          <a
            ...
            className="inline-flex items-center gap-1 text-[10px] text-[#64748B] hover:text-[#7C3AED] transition-colors mb-2"
          >
