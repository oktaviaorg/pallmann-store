      ...
      <div className="min-h-screen flex flex-col bg-[#FFFFFF]">
        ...
        <main className="flex-grow">
          ...
          <div 
            ...
            style={{ background: 'linear-gradient(135deg, #1A1A1A 0%, #243B53 30%, #D35400 70%, #E67E22 100%)' }}
          >
          ...
          <div className="max-w-6xl mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-4">
                    <input
                      ...
                      style={{ 
                        background: `linear-gradient(to right, #E67E22 0%, #E67E22 ${(surface-5)/195*100}%, #D4D4D4 ${(surface-5)/195*100}%, #D4D4D4 100%)` 
                      }}
                    />
                    <div className="flex items-center gap-1 bg-[#F8FAFC] px-4 py-2 rounded-xl">
                      <input
                        ...
                        className="w-16 text-center font-bold text-[#1A1A1A] bg-transparent focus:outline-none"
                      />
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <div className="font-bold text-[#1A1A1A]">Rénovation</div>
                      <div className="text-xs text-[#6B6B6B]">Parquet existant à rénover</div>
                    </button>
                    <button
                    ...
                    >
                      <div className="font-bold text-[#1A1A1A]">Parquet neuf</div>
                      <div className="text-xs text-[#6B6B6B]">Première mise en finition</div>
                    </button>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <div className="font-bold text-[#1A1A1A]">Vitrification</div>
                      <div className="text-xs text-[#6B6B6B]">Protection maximale, brillant à mat</div>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <div className="font-bold text-[#1A1A1A]">Huilage</div>
                      <div className="text-xs text-[#6B6B6B]">Aspect naturel, toucher bois</div>
                    </button>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    {projectType === 'renovation' && (
                      <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:border-[#E67E22]/50 cursor-pointer transition-all bg-white">
                        ...
                        <div className="flex-grow">
                          <div className="font-semibold text-[#1A1A1A] text-sm">PALL-X KITT - Liant</div>
                          <div className="text-xs text-[#6B6B6B]">Rebouchage joints et fissures</div>
                        </div>
                    ...
                    <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:border-[#E67E22]/50 cursor-pointer transition-all bg-white">
                      ...
                      />
                      <div className="flex-grow">
                        <div className="font-semibold text-[#1A1A1A] text-sm">Spatule inox crantée</div>
                        <div className="text-xs text-[#6B6B6B]">Application uniforme du fond dur</div>
                      </div>
                    ...
                    <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:border-[#E67E22]/50 cursor-pointer transition-all bg-white">
                      ...
                      />
                      <div className="flex-grow">
                        <div className="font-semibold text-[#1A1A1A] text-sm">Rouleau microfibre PRO</div>
                        <div className="text-xs text-[#6B6B6B]">25cm pour vitrificateur/huile</div>
                      </div>
                    ...
                    <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:border-[#E67E22]/50 cursor-pointer transition-all bg-white">
                      ...
                      />
                      <div className="flex-grow">
                        <div className="font-semibold text-[#1A1A1A] text-sm">CLEAN & GO - Nettoyant</div>
                        <div className="text-xs text-[#6B6B6B]">Préparation avant application</div>
                      </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-[#6B6B6B]">{product.quantity} {product.unit} × {product.pricePerUnit}€</p>
                      </div>
                ...
                {/* Total */}
                <div className="bg-[#1A1A1A] text-white rounded-xl p-4 mb-6">
            ...
            <div className="mt-12 bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-[#1A1A1A] mb-6">Questions fréquentes</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#1A1A1A] mb-1">Combien de vitrificateur pour 20m² ?</h3>
                  <p className="text-[#6B6B6B] text-sm">Pour 20m², comptez environ 2L de fond dur et 4L de vitrificateur (2 couches). Le rendement moyen est de 10-12m² par litre.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#1A1A1A] mb-1">Quelle différence entre vitrification et huilage ?</h3>
                  <p className="text-[#6B6B6B] text-sm">La vitrification forme un film protecteur en surface (aspect brillant à mat). L'huilage pénètre le bois pour un aspect naturel. La vitrification est plus résistante, l'huile plus facile à réparer localement.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#1A1A1A] mb-1">Puis-je commander pour un professionnel ?</h3>
                  <p className="text-[#6B6B6B] text-sm">Oui ! Inscrivez-vous sur notre <Link to="/pro" className="text-[#E67E22] underline">espace PRO</Link> pour bénéficier de remises exclusives et de tarifs dégressifs.</p>
                </div>
              </div>
            </div>
          </div>
