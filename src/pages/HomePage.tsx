        ...
        <main className="flex-grow">
          ...
          <div className="relative overflow-hidden">
            <div 
              ...
              style={{ 
                background: 'linear-gradient(135deg, #C41E3A 0%, #9B1830 50%, #C41E3A 100%)'
              }}
            ></div>
            ...
            <div 
              ...
              style={{
                background: 'radial-gradient(circle at 20% 80%, #C41E3A 0%, transparent 50%)',
              }}
            ></div>
                      ...
                      <div 
                        ...
                        style={{ 
                          ...
                          background: francoProgress >= 100 
                            ...
                            : 'linear-gradient(90deg, #C41E3A 0%, #9B1830 100%)'
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <stat.icon className="w-6 h-6 mx-auto mb-2 text-[#C41E3A]" />
          ...
          <div className="bg-gradient-to-r from-[#F8FAFC] to-[#F8FAFC] py-6 border-y border-[#BCCCDC]">
            <div className="max-w-7xl mx-auto px-4">
              <Link 
                to="/calculateur-pro"
                className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white rounded-2xl p-6 shadow-lg border-2 border-[#C41E3A]/20 hover:border-[#C41E3A] transition-all hover:shadow-xl group"
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#C41E3A] to-[#9B1830] flex items-center justify-center text-white">
                    <Calculator className="w-7 h-7" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-[#1A1A1A] group-hover:text-[#C41E3A] transition-colors">
                      🧮 Calculateur PRO
                    </h3>
            ...
            <div className="max-w-7xl mx-auto px-4 py-3">
              <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide pb-1">
                <a
                  ...
                  style={selectedCategory === 'all' ? { background: 'linear-gradient(135deg, #C41E3A 0%, #9B1830 100%)' } : {}}
                >
                ...
                {categories.map(cat => {
                  ...
                  return (
                    <a
                      ...
                      style={selectedCategory === cat.id ? { background: 'linear-gradient(135deg, #C41E3A 0%, #9B1830 100%)' } : {}}
                    >
                      {cat.name} ({count})
                    </a>
                  );
            ...
            <div className="bg-gradient-to-b from-[#FFFFFF] to-white py-12">
              <div className="max-w-7xl mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <a 
                    href="#products"
                    className="hidden md:flex items-center gap-1 text-[#C41E3A] font-semibold hover:underline"
                  >
                    Voir tout
          ...
          <div className="bg-white py-12 lg:py-16">
            <div className="max-w-7xl mx-auto px-4">
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 bg-[#D9E2EC] text-[#9B1830] px-4 py-2 rounded-full text-sm font-bold mb-4">
                  ...
                  return (
                    <div 
                      ...
                      className={`group relative bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 ${
                        inQuote ? 'border-[#C41E3A] ring-2 ring-[#C41E3A]/20' : 'border-gray-100'
                      }`}
                    >
                        ...
                        <button
                          ...
                          className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all ${
                            inQuote 
                              ...
                              : 'bg-white/90 border-2 border-gray-300 hover:border-[#C41E3A]'
                          }`}
                        >
                      ...
                      <div 
                        ...
                        style={{ background: 'linear-gradient(90deg, #C41E3A 0%, #9B1830 100%)' }}
                      ></div>
                      ...
                      <div className="relative bg-gradient-to-br from-[#FFFFFF] to-[#F8FAFC] p-6 h-48 flex items-center justify-center overflow-hidden">
                        {machine.image ? (
                          ...
                          <div className="w-24 h-24 bg-gradient-to-br from-[#C41E3A]/10 to-[#9B1830]/10 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <Zap className="w-12 h-12 text-[#C41E3A] group-hover:text-[#9B1830] transition-colors" />
                          </div>
                        )}
                      </div>

                      <div className="p-5">
                        <h3 className="text-lg font-extrabold text-[#1A1A1A] mb-1 group-hover:text-[#C41E3A] transition-colors">
                          {machine.name}
                        </h3>
                        ...
                        <div className="flex flex-wrap gap-1 mb-4">
                          {machine.features.map((feature, i) => (
                            <span 
                              key={i}
                              className="text-[10px] font-medium px-2 py-0.5 bg-[#F8FAFC] text-[#C41E3A] rounded"
                            >
                              {feature}
                            </span>
                          ))}
                        ...
                        <button
                          ...
                          style={!inQuote ? { background: 'linear-gradient(135deg, #C41E3A 0%, #9B1830 100%)' } : {}}
                        >
                          {inQuote ? (
                            <>
                              <CheckCircle className="w-4 h-4" />
              ...
              {machinesPro.some(m => isInQuote(`machine-${m.id}`)) && (
                <div className="mt-8 text-center">
                  <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-gradient-to-r from-[#C41E3A]/10 to-[#9B1830]/10 p-6 rounded-2xl border border-[#C41E3A]/20">
          ...
          <div id="products" className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="bg-white rounded-2xl shadow-card p-4 md:p-6 mb-8 border border-gray-100">
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#C41E3A] focus:border-transparent transition-all text-[#1A1A1A]"
                />
              </div>
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all ${
                        selectedSubcategory === 'all'
                          ? 'bg-[#C41E3A] text-white'
                          : 'bg-blue-50 text-[#C41E3A] hover:bg-blue-100'
                      }`}
                    >
                      Toutes
                    </button>
              ...
              {(selectedCategory !== 'all' || selectedSubcategory !== 'all' || searchTerm) && (
                <div className="mt-4 flex items-center justify-between text-sm">
                  ...
                  <button
                    ...
                    className="text-[#9B1830] font-semibold hover:underline"
                  >
                    Réinitialiser
                  </button>
                </div>
            ...
            <div 
              ...
              style={{ background: 'linear-gradient(135deg, #1A1A1A 0%, #243B53 50%, #C41E3A 100%)' }}
            >
              <div 
                className="absolute top-0 left-0 right-0 h-1"
                style={{ background: 'linear-gradient(90deg, #C41E3A 0%, #9B1830 100%)' }}
