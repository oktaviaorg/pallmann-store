...
const LandingBasRhin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fafaf8]">
      <Helmet>
        <title>Ponçage Parquet Bas-Rhin (67) | Les Ponceurs Réunis | Devis 24h</title>
        <meta name="description" content="⭐ Les Ponceurs Réunis : Artisan ponçage parquet Strasbourg & Bas-Rhin ✓ Devis gratuit 24h ✓ 15 ans d'expérience ✓ Garantie décennale ✓ Prix transparent ☎️ 07 57 82 13 06" />
        <link rel="canonical" href="https://ponceur-parquet.fr/landing/bas-rhin" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Ponçage Parquet Bas-Rhin (67) | Les Ponceurs Réunis | Devis 24h" />
        <meta property="og:description" content="Les Ponceurs Réunis : Artisan expert en ponçage de parquet à Strasbourg et Bas-Rhin. Devis gratuit sous 24h, intervention rapide." />
        <meta property="og:url" content="https://ponceur-parquet.fr/landing/bas-rhin" />
        ...
        <meta name="geo.placename" content="Strasbourg, Bas-Rhin" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Les Ponceurs Réunis - Ponçage Parquet Strasbourg Bas-Rhin",
            "description": "Expert en ponçage et rénovation de parquet à Strasbourg et dans le Bas-Rhin",
            "telephone": "+33757821306",
            "priceRange": "€€",
            "areaServed": ["Strasbourg", "Haguenau", "Saverne", "Sélestat", "Obernai", "Bas-Rhin"],
      ...
      <section className="relative isolate overflow-hidden pt-20 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-3 mb-6">
                <div className="inline-flex items-center gap-2 bg-[#d9b45a]/10 border border-[#d9b45a]/30 rounded-full px-4 py-2">
                  ...
                  <span className="text-sm font-semibold text-[#b8941a]">Strasbourg • Haguenau • Bas-Rhin</span>
                </div>
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                ...
                Redonnez vie à vos sols avec un artisan qualifié du Bas-Rhin.
              </p>
            ...
            {/* Right Column - Image & Trust Badges */}
              ...
              <div className="relative bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] hover:shadow-[0_25px_80px_rgba(184,148,26,0.25)] transition-all duration-500 overflow-hidden h-[500px] w-[416px] lg:h-[650px] lg:w-[500px] border-4 border-[#d9b45a]/30 hover:border-[#b8941a]/50 ring-4 ring-[#d9b45a]/10">
                ...
                <div className="absolute inset-0 rounded-2xl overflow-hidden z-0">
                  <img
                    ...
                    alt="Chantier de ponçage parquet Strasbourg"
                ...
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-10 w-[374px] h-[500px] lg:w-[436px] lg:h-[562px]">
                  <img
                    ...
                    alt="Julien DIETEMANN - Expert parquet Strasbourg"
                    width="436"
                    height="562"
      ...
      <section className="py-12 bg-white border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <Users className="w-8 h-8 text-[#b8941a] mx-auto mb-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Nos Services à <span className="text-[#b8941a]">Strasbourg & Bas-Rhin</span>
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-2">
              ...
              <span className="text-sm font-semibold text-green-700">15 demandes cette semaine</span>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Autre Bas-Rhin">Autre ville du Bas-Rhin</option>
                </select>
              </div>
