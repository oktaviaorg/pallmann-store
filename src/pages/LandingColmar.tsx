...
const LandingColmar: React.FC = () => {
  ...
  const colmarQuarters = [
    'Centre-ville', 'Petite Venise', 'Quartier des Maraîchers', 'Mittlere Platz', 'Koïfhus',
    'Quartier Ouest', 'Quartier Schweitzer', 'Europe', 'Logelbach', 'Saint-Joseph'
  ];

  const nearbyTowns = [
    'Horbourg-Wihr', 'Ingersheim', 'Wintzenheim', 'Turckheim', 'Houssen',
    'Herrlisheim-près-Colmar', 'Andolsheim', 'Sundhoffen', 'Walbach', 'Fortschwihr'
  ];

  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#fafaf8] to-white">
      <Helmet>
        <title>Rénovation Parquet Colmar (68) | Les Ponceurs Réunis | Devis 24h</title>
        <meta
          name="description"
          content="⭐ Les Ponceurs Réunis : Expert rénovation parquet à Colmar 68 - ponçage sans poussière, vitrification, pose. Intervention Centre-ville, Petite Venise. Devis gratuit 24h ☎️ 07 57 82 13 06."
        />
        <meta
          name="keywords"
          content="pose parquet Colmar, rénovation parquet Colmar, ponçage parquet Colmar, vitrification parquet Colmar, artisan parquet Colmar 68, parqueteur Colmar, ponçage sans poussière Colmar, pose parquet massif Colmar, parquet Petite Venise, parquet centre-ville Colmar, Les Ponceurs Réunis"
        />
        <link rel="canonical" href="https://ponceur-parquet.fr/renovation-parquet-colmar" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Rénovation Parquet Colmar (68) | Les Ponceurs Réunis | Devis 24h" />
        <meta property="og:description" content="Les Ponceurs Réunis : Expert en rénovation de parquet à Colmar. Ponçage sans poussière, vitrification, pose. Intervention rapide tous quartiers." />
        <meta property="og:url" content="https://ponceur-parquet.fr/renovation-parquet-colmar" />
        ...
        <meta name="geo.position" content="48.0784;7.3583" />
        <meta name="ICBM" content="48.0784, 7.3583" />

        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Les Ponceurs Réunis - Pose & Rénovation Parquet Colmar",
            "description": "Expert en pose et rénovation de parquet à Colmar : ponçage sans poussière, vitrification écologique, pose de parquet massif et contrecollé, réparation. Artisan de confiance avec 20 ans d'expérience. Intervention dans tous les quartiers de Colmar et le Haut-Rhin.",
            "url": "https://ponceur-parquet.fr/renovation-parquet-colmar",
            ...
            "hasOfferCatalog": {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Ponçage de parquet à Colmar",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Vitrification de parquet à Colmar",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Réparation de parquet à Colmar",
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Pose & Rénovation Parquet Colmar",
                "item": "https://ponceur-parquet.fr/renovation-parquet-colmar"
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Combien coûte la pose ou rénovation d'un parquet à Colmar ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Le coût varie selon le type de parquet et le service : pose de parquet massif à partir de 55€/m², ponçage et vitrification à partir de 42€/m². Nous proposons un devis gratuit sous 24h adapté à votre projet à Colmar et sa région."
                }
              },
              {
                "@type": "Question",
                "name": "Intervenez-vous dans tous les quartiers de Colmar ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Oui, nous intervenons dans tous les quartiers de Colmar : Centre-ville, Petite Venise, Quartier des Maraîchers, Quartier Ouest, et toutes les communes limitrophes comme Horbourg-Wihr, Ingersheim, Wintzenheim, Turckheim, Houssen, Herrlisheim-près-Colmar."
                }
              },
              {
                "@type": "Question",
                "name": "Quels types de parquet posez-vous à Colmar ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Nous posons tous types de parquets : parquet massif (chêne, hêtre, châtaignier), parquet contrecollé, parquet flottant, parquet cloué. Nous proposons également la pose de parquets spéciaux comme le point de Hongrie ou Versailles, parfaits pour les belles demeures colmariennes."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Non, nous utilisons un système de ponçage sans poussière avec aspiration intégrée. Plus de 99% de la poussière est captée directement, garantissant un chantier propre à Colmar, idéal pour les habitations du centre historique."
                }
              }
            ]
          })}
      ...
      <main className="flex-grow">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#d9b45a]/20 border border-[#d9b45a]/30 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium text-[#d9b45a]">Intervention à Colmar (68)</span>
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  Pose & Rénovation de Parquet
                  <span className="block text-[#d9b45a] mt-2">à Colmar</span>
                </h1>

                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Artisan expert en pose de parquet, ponçage sans poussière, vitrification et réparation.
                  Intervention rapide dans tous les quartiers de Colmar et le Haut-Rhin.
                </p>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-[#fafaf8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Zones d'intervention à Colmar
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Nous intervenons dans tous les quartiers de Colmar et ses communes limitrophes
              </p>
            </div>
        ...
        <section className="py-16 bg-[#fafaf8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Pourquoi nous choisir à Colmar ?
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg text-center">
                ...
                <p className="text-gray-600">Artisan local basé à Herrlisheim</p>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Réponse sous 24h pour votre projet de parquet à Colmar
              </p>
            </div>
        ...
        <LocalGallery
          cityName="Colmar"
          title="Nos Réalisations à Colmar"
          subtitle="Découvrez quelques-unes de nos réalisations de pose et rénovation de parquet dans la région de Colmar"
          limit={6}
        />

        <LocalFAQ cityName="Colmar" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <NearbyCities
            currentCity="Colmar"
            cities={[
              { name: "Strasbourg", url: "/renovation-parquet-strasbourg", distance: "70 km" },
              { name: "Mulhouse", url: "/renovation-parquet-mulhouse", distance: "40 km" },
              { name: "Belfort", url: "/renovation-parquet-belfort", distance: "60 km" },
              { name: "Sarrebourg", url: "/renovation-parquet-sarrebourg", distance: "90 km" },
              { name: "Dijon", url: "/renovation-parquet-dijon", distance: "150 km" },
              { name: "Beaune", url: "/renovation-parquet-beaune", distance: "120 km" }
            ]}
          />
        </div>
      </main>
