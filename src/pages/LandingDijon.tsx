...
const LandingDijon: React.FC = () => {
  ...
  const dijonQuarters = [
    'Centre-ville', 'Les Bourroches', 'Les Grésilles', 'Fontaine d\'Ouche', 'Montchapet',
    'Toison d\'Or', 'La Maladière', 'Chevreul', 'Clemenceau', 'Port du Canal'
  ];

  const nearbyTowns = [
    'Chenôve', 'Longvic', 'Quetigny', 'Talant', 'Fontaine-lès-Dijon',
    'Marsannay-la-Côte', 'Neuilly-lès-Dijon', 'Perrigny-lès-Dijon', 'Chevigny-Saint-Sauveur', 'Sennecey-lès-Dijon'
  ];

  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#fafaf8] to-white">
      <Helmet>
        <title>Rénovation Parquet Dijon (21) | Les Ponceurs Réunis | Devis 24h</title>
        <meta
          name="description"
          content="⭐ Les Ponceurs Réunis : Expert rénovation parquet à Dijon 21 - ponçage sans poussière, vitrification, pose. Intervention Centre-ville, Bourroches, Grésilles. Devis gratuit 24h ☎️ 07 57 82 13 06."
        />
        <meta
          name="keywords"
          content="pose parquet Dijon, rénovation parquet Dijon, ponçage parquet Dijon, vitrification parquet Dijon, artisan parquet Dijon 21, parqueteur Dijon, ponçage sans poussière Dijon, pose parquet massif Dijon, parquet centre-ville Dijon, parquet Côte-d'Or, Les Ponceurs Réunis"
        />
        <link rel="canonical" href="https://ponceur-parquet.fr/renovation-parquet-dijon" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Rénovation Parquet Dijon (21) | Les Ponceurs Réunis | Devis 24h" />
        <meta property="og:description" content="Les Ponceurs Réunis : Expert en rénovation de parquet à Dijon. Ponçage sans poussière, vitrification, pose. Intervention rapide tous quartiers." />
        <meta property="og:url" content="https://ponceur-parquet.fr/renovation-parquet-dijon" />
        ...
        <meta name="geo.position" content="47.3220;5.0415" />
        <meta name="ICBM" content="47.3220, 5.0415" />

        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Les Ponceurs Réunis - Pose & Rénovation Parquet Dijon",
            "description": "Expert en pose et rénovation de parquet à Dijon : ponçage sans poussière, vitrification écologique, pose de parquet massif et contrecollé, réparation. Artisan de confiance avec 20 ans d'expérience. Intervention dans tous les quartiers de Dijon et la Côte-d'Or.",
            "url": "https://ponceur-parquet.fr/renovation-parquet-dijon",
            ...
            "hasOfferCatalog": {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Ponçage de parquet à Dijon",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Vitrification de parquet à Dijon",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Réparation de parquet à Dijon",
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Pose & Rénovation Parquet Dijon",
                "item": "https://ponceur-parquet.fr/renovation-parquet-dijon"
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Combien coûte la pose ou rénovation d'un parquet à Dijon ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Le coût varie selon le type de parquet et le service : pose de parquet massif à partir de 55€/m², ponçage et vitrification à partir de 42€/m². Nous proposons un devis gratuit sous 24h adapté à votre projet à Dijon et sa région."
                }
              },
              {
                "@type": "Question",
                "name": "Intervenez-vous dans tous les quartiers de Dijon ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Oui, nous intervenons dans tous les quartiers de Dijon : Centre-ville, Les Bourroches, Les Grésilles, Fontaine d'Ouche, Montchapet, Toison d'Or, et toutes les communes limitrophes comme Chenôve, Longvic, Quetigny, Talant, Fontaine-lès-Dijon."
                }
              },
              {
                "@type": "Question",
                "name": "Quels types de parquet posez-vous à Dijon ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Nous posons tous types de parquets : parquet massif (chêne, hêtre, châtaignier), parquet contrecollé, parquet flottant, parquet cloué. Nous proposons également la pose de parquets spéciaux comme le point de Hongrie ou Versailles, parfaits pour les belles demeures dijonnaises."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Non, nous utilisons un système de ponçage sans poussière avec aspiration intégrée. Plus de 99% de la poussière est captée directement, garantissant un chantier propre à Dijon, idéal pour les habitations du centre historique."
                }
              }
            ]
          })}
      ...
      <main className="flex-grow">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#d9b45a]/20 border border-[#d9b45a]/30 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium text-[#d9b45a]">Intervention à Dijon (21)</span>
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  Pose & Rénovation de Parquet
                  <span className="block text-[#d9b45a] mt-2">à Dijon</span>
                </h1>

                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Artisan expert en pose de parquet, ponçage sans poussière, vitrification et réparation.
                  Intervention rapide dans tous les quartiers de Dijon et la Côte-d'Or.
                </p>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-[#fafaf8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Zones d'intervention à Dijon
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Nous intervenons dans tous les quartiers de Dijon et ses communes limitrophes
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg text-center">
                ...
                <p className="text-gray-600">Équipe d'artisan local basé à Dijon</p>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Réponse sous 24h pour votre projet de parquet à Dijon
              </p>
            </div>
        ...
        <LocalGallery
          cityName="Dijon"
          title="Nos Réalisations à Dijon"
          subtitle="Découvrez quelques-unes de nos réalisations de pose et rénovation de parquet dans la région dijonnaise"
          limit={6}
        />

        <LocalFAQ cityName="Dijon" />
      </main>
