...
const LandingLyon: React.FC = () => {
  ...
  const lyonQuarters = [
    'Centre-ville', 'Presqu\'île', 'Vieux Lyon', 'Croix-Rousse', 'Part-Dieu',
    'Gerland', 'Confluence', 'Monplaisir', 'Guillotière', 'Brotteaux',
    'Vaise', 'Saint-Jean', 'Terreaux', 'Bellecour', 'Perrache'
  ];

  const nearbyTowns = [
    'Villeurbanne', 'Vénissieux', 'Caluire-et-Cuire', 'Saint-Priest', 'Vaulx-en-Velin',
    'Bron', 'Oullins', 'Écully', 'Tassin-la-Demi-Lune', 'Rillieux-la-Pape'
  ];

  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#fafaf8] to-white">
      <Helmet>
        <title>Rénovation Parquet Lyon (69) | Expert Ponçage & Vitrification | Devis Gratuit</title>
        <meta
          name="description"
          content="Expert rénovation parquet Lyon et Rhône. Ponçage, vitrification, pose et réparation de parquet. Intervention rapide dans toute la métropole lyonnaise. Devis gratuit sous 24h ☎️ 07 57 82 13 06."
        />
        <meta
          name="keywords"
          content="rénovation parquet Lyon, ponçage parquet Lyon, vitrification parquet Lyon 69, artisan parquet Lyon, ponçage parquet Rhône, pose parquet massif Lyon, parqueteur Lyon, ponçage sans poussière Lyon, rénovation parquet Villeurbanne"
        />
        <link rel="canonical" href="https://ponceur-parquet.fr/renovation-parquet-lyon" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Rénovation Parquet Lyon (69) | Expert Ponçage & Vitrification" />
        <meta property="og:description" content="Expert en rénovation de parquet à Lyon et métropole. Ponçage, vitrification, pose, réparation. Intervention rapide dans tous les quartiers." />
        <meta property="og:url" content="https://ponceur-parquet.fr/renovation-parquet-lyon" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Les Ponceurs Réunis - Pose & Rénovation Parquet Lyon",
            "description": "Expert en pose et rénovation de parquet à Lyon : ponçage, vitrification, pose de parquet massif et contrecollé, réparation. Artisan de confiance avec 15 ans d'expérience. Intervention dans tous les quartiers de Lyon et sa métropole.",
            "url": "https://ponceur-parquet.fr/renovation-parquet-lyon",
            ...
            "hasOfferCatalog": {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Ponçage de parquet à Lyon",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Vitrification de parquet à Lyon",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Réparation de parquet à Lyon",
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Pose & Rénovation Parquet Lyon",
                "item": "https://ponceur-parquet.fr/renovation-parquet-lyon"
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Combien coûte la rénovation d'un parquet à Lyon ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Le coût de rénovation d'un parquet à Lyon varie selon la surface et l'état du parquet. En moyenne, comptez 42€/m² pour un ponçage et vitrification classique. Nous proposons un devis gratuit sous 24h adapté à votre projet."
                }
              },
              {
                "@type": "Question",
                "name": "Intervenez-vous dans tous les quartiers de Lyon ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Oui, nous intervenons dans tous les quartiers de Lyon : Centre-ville, Presqu'île, Vieux Lyon, Croix-Rousse, Part-Dieu, Gerland, Confluence, Monplaisir, et tous les autres quartiers ainsi que les communes de la métropole lyonnaise."
                }
              },
              {
                "@type": "Question",
      ...
      <main className="flex-grow">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#d9b45a]/20 border border-[#d9b45a]/30 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium text-[#d9b45a]">Intervention à Lyon (69)</span>
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  Pose & Rénovation de Parquet
                  <span className="block text-[#d9b45a] mt-2">à Lyon</span>
                </h1>

                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Artisan expert en pose de parquet, ponçage, vitrification et réparation.
                  Intervention rapide dans tous les quartiers de Lyon et la métropole.
                </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">
                    Zone de franchise en cours d'attribution
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    Le secteur de Lyon et sa métropole est actuellement en cours d'enregistrement dans notre réseau de franchises.
                    Nous sommes en mesure d'intervenir sur votre projet dès maintenant. N'hésitez pas à nous contacter pour un devis gratuit et personnalisé.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-[#fafaf8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Zones d'intervention à Lyon
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Nous intervenons dans tous les quartiers de Lyon et les communes de la métropole
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Réponse sous 24h pour votre projet de rénovation de parquet à Lyon
              </p>
            </div>
        ...
        <LocalGallery
          ...
          subtitle="Découvrez quelques-unes de nos réalisations de pose et rénovation de parquet dans la région lyonnaise"
          limit={6}
        />

        <LocalFAQ cityName="Lyon" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <NearbyCities
            currentCity="Lyon"
            cities={[
              { name: "Beaune", url: "/renovation-parquet-beaune", distance: "150 km" },
              { name: "Dijon", url: "/renovation-parquet-dijon", distance: "190 km" },
              { name: "Belfort", url: "/renovation-parquet-belfort", distance: "210 km" },
              { name: "Colmar", url: "/renovation-parquet-colmar", distance: "270 km" },
              { name: "Mulhouse", url: "/renovation-parquet-mulhouse", distance: "250 km" },
              { name: "Strasbourg", url: "/renovation-parquet-strasbourg", distance: "320 km" }
            ]}
          />
        </div>
      </main>
