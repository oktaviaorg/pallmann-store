...
const LandingSarrebourg: React.FC = () => {
  ...
  const sarrebourgQuarters = [
    'Centre-ville', 'Faubourg de France', 'Faubourg de Saverne', 'Quartier de la Gare', 'Quartier du Moulin',
    'Les Vosges', 'Quartier Saint-Nicolas', 'La Promenade', 'Les Remparts', 'Quartier des Tanneries'
  ];

  const nearbyTowns = [
    'Réding', 'Buhl-Lorraine', 'Troisfontaines', 'Imling', 'Hesse',
    'Berthelming', 'Fénétrange', 'Héming', 'Gosselming', 'Langatte'
  ];

  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#fafaf8] to-white">
      <Helmet>
        <title>Rénovation Parquet Sarrebourg (57) | Les Ponceurs Réunis | Devis 24h</title>
        <meta
          name="description"
          content="⭐ Les Ponceurs Réunis : Expert rénovation parquet à Sarrebourg 57 - ponçage, vitrification, pose, réparation. Intervention dans tous les quartiers. Devis gratuit sous 24h ☎️ 07 57 82 13 06."
        />
        <meta
          name="keywords"
          content="pose parquet Sarrebourg, rénovation parquet Sarrebourg, ponçage parquet Sarrebourg, vitrification parquet Sarrebourg, artisan parquet Sarrebourg 57, parqueteur Sarrebourg, ponçage sans poussière Sarrebourg, pose parquet massif Sarrebourg, Les Ponceurs Réunis"
        />
        <link rel="canonical" href="https://ponceur-parquet.fr/renovation-parquet-sarrebourg" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Rénovation Parquet Sarrebourg (57) | Les Ponceurs Réunis | Devis 24h" />
        <meta property="og:description" content="Les Ponceurs Réunis : Expert en rénovation de parquet à Sarrebourg. Ponçage, vitrification, pose. Intervention rapide dans tous les quartiers." />
        <meta property="og:url" content="https://ponceur-parquet.fr/renovation-parquet-sarrebourg" />
        ...
        <meta name="geo.position" content="48.7356;7.0545" />
        <meta name="ICBM" content="48.7356, 7.0545" />

        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Les Ponceurs Réunis - Pose & Rénovation Parquet Sarrebourg",
            "description": "Expert en pose et rénovation de parquet à Sarrebourg : ponçage, vitrification, pose de parquet massif et contrecollé, réparation. Artisan de confiance avec 15 ans d'expérience. Intervention dans tous les quartiers de Sarrebourg et environs.",
              ...
              "itemListElement": [
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Pose de parquet à Sarrebourg",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Ponçage de parquet à Sarrebourg",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Vitrification de parquet à Sarrebourg",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Réparation de parquet à Sarrebourg",
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Pose & Rénovation Parquet Sarrebourg",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Combien coûte la pose ou rénovation d'un parquet à Sarrebourg ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Le coût varie selon le type de parquet et le service : pose de parquet massif à partir de 55€/m², ponçage et vitrification à partir de 42€/m². Nous proposons un devis gratuit sous 24h adapté à votre projet à Sarrebourg."
                }
              },
              {
                "@type": "Question",
                "name": "Intervenez-vous dans tous les quartiers de Sarrebourg ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Oui, nous intervenons dans tous les quartiers de Sarrebourg : Centre-ville, Faubourg de France, Faubourg de Saverne, Quartier de la Gare, et toutes les communes limitrophes comme Réding, Buhl-Lorraine, Troisfontaines."
                }
              },
              {
                "@type": "Question",
                "name": "Quels types de parquet posez-vous à Sarrebourg ?",
                "acceptedAnswer": {
                  "@type": "Answer",
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Non, nous utilisons un système de ponçage sans poussière avec aspiration intégrée. Plus de 99% de la poussière est captée directement, garantissant un chantier propre à Sarrebourg."
                }
              }
            ]
          })}
      ...
      <main className="flex-grow">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#d9b45a]/20 border border-[#d9b45a]/30 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium text-[#d9b45a]">Intervention à Sarrebourg (57)</span>
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  Pose & Rénovation de Parquet
                  <span className="block text-[#d9b45a] mt-2">à Sarrebourg</span>
                </h1>

                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Artisan expert en pose de parquet, ponçage, vitrification et réparation.
                  Intervention rapide dans tous les quartiers de Sarrebourg et la Moselle.
                </p>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-[#fafaf8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Zones d'intervention à Sarrebourg
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Nous intervenons dans tous les quartiers de Sarrebourg et ses communes limitrophes
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-100 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                Quartiers de Sarrebourg
              </h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                {sarrebourgQuarters.map((quarter) => (
        ...
        <section className="py-16 bg-[#fafaf8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Pourquoi nous choisir à Sarrebourg ?
              </h2>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Réponse sous 24h pour votre projet de parquet à Sarrebourg
              </p>
            </div>
        ...
        <LocalGallery
          cityName="Sarrebourg"
          title="Nos Réalisations à Sarrebourg"
          subtitle="Découvrez quelques-unes de nos réalisations de pose et rénovation de parquet dans la région de Sarrebourg"
          limit={6}
        />

        <LocalFAQ cityName="Sarrebourg" />
      </main>
...
export default LandingSarrebourg;
