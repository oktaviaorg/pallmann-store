      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <main className="flex-grow pt-24 pb-16">
          ...
          <div className="bg-white border-b border-gray-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              <nav className="flex items-center space-x-2 text-sm">
                ...
                <Link to="/boutique" className="text-gray-500 hover:text-[#d9b45a] transition-colors">
                  Boutique
                </Link>
                <ChevronRight className="w-4 h-4 text-gray-400" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
            ...
            {/* Info Banner */}
            <div className="bg-gradient-to-r from-[#ff9900] to-[#f0c300] rounded-2xl shadow-xl p-8 mb-8 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              {/* Contact rapide */}
              <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-[#ff9900]">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-[#ff9900] hover:bg-[#f0c300] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all w-full justify-center shadow-md hover:shadow-lg hover:scale-105"
                >
              ...
              {/* Email rapide */}
              <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-[#d9b45a]">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 bg-[#d9b45a] rounded-full flex items-center justify-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-l-4 border-[#ff9900]">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[#ff9900] to-[#f0c300] rounded-full flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full inline-flex items-center gap-3 bg-gradient-to-r from-[#ff9900] to-[#f0c300] hover:from-[#f0c300] hover:to-[#ff9900] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all shadow-lg hover:shadow-xl hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed justify-center"
                >
                  {loading ? (
                    <>
            ...
            <div className="mt-8 text-center">
              <Link
                to="/boutique"
                className="inline-flex items-center gap-2 text-gray-600 hover:text-[#ff9900] transition-colors font-semibold"
              >
