/*
  # Fix duplicate article slug

  1. Changes
    - Update the article slug to make it unique by adding a timestamp
    - Keep all other article data the same
*/

-- Insert new article with a unique slug
...
VALUES (
  ...
  'parquet-pro-pose-renovation-bois-qualite-duo-parqueteur-' || to_char(NOW(), 'YYYYMMDD'),
