...
UPDATE articles
SET
  content = '# Parquet abîmé par locataire : responsabilités, recours et solutions de rénovation
...
<div class="profile-selector" style="background: linear-gradient(135deg, #f8f9fb 0%, #e9ecf0 100%); padding: 3rem 2rem; border-radius: 20px; margin: 2.5rem 0; text-align: center; box-shadow: 0 8px 16px rgba(0,0,0,0.08);">
  <h2 style="font-size: 2rem; margin-bottom: 1rem; color: #1a202c; font-weight: 700;">👋 Bienvenue ! Qui êtes-vous ?</h2>
  <p style="font-size: 1.05rem; color: #64748b; margin-bottom: 2.5rem; max-width: 600px; margin-left: auto; margin-right: auto;">Cliquez sur votre profil pour accéder directement aux informations qui vous concernent</p>

  <div style="display: flex; gap: 1.5rem; flex-wrap: wrap; justify-content: center; max-width: 1100px; margin: 0 auto;">
    <a href="#proprietaire" class="profile-card" style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); box-shadow: 0 4px 12px rgba(37,99,235,0.4);">
      <span class="profile-icon">🏠</span>
      <div class="profile-title">Propriétaire bailleur</div>
      <div class="profile-desc">Récupérer les frais de rénovation sur la caution</div>
      <div class="profile-arrow">→</div>
    </a>

    <a href="#locataire" class="profile-card" style="background: linear-gradient(135deg, #059669 0%, #047857 100%); box-shadow: 0 4px 12px rgba(5,150,105,0.4);">
      <span class="profile-icon">🔑</span>
      <div class="profile-title">Locataire</div>
      <div class="profile-desc">Réparer avant l''état des lieux et éviter la retenue</div>
      <div class="profile-arrow">→</div>
    </a>

    <a href="#agence" class="profile-card" style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); box-shadow: 0 4px 12px rgba(220,38,38,0.4);">
      <span class="profile-icon">🏢</span>
      <div class="profile-title">Agence immobilière</div>
      <div class="profile-desc">Tarifs dégressifs et services dédiés aux pros</div>
      <div class="profile-arrow">→</div>
    </a>
  </div>
</div>
...
|------------|------------|
| Ponçage parquet (3 passes) | 22 à 32 €/m² |
| Ponçage + vitrification 3 couches | 32 à 45 €/m² |
| Huilage parquet naturel | 38 à 49 €/m² |
| Réparation de lames / seuils | Sur devis |
| Remplacement partiel de lames | 60 à 100 €/m² |

⚠️ *Ces tarifs sont indicatifs et peuvent varier selon l''essence du bois, l''état du parquet et la surface totale. Application de la vétusté selon la loi.*
...
<div class="cta-box" style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: white; padding: 2rem; border-radius: 16px; margin: 2rem 0; text-align: center; box-shadow: 0 8px 16px rgba(37,99,235,0.3);">
  ...
  <a href="tel:+33757821306" style="display: inline-block; background: white; color: #2563eb; padding: 1rem 2.5rem; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 1.1rem; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">📞 Obtenir un devis gratuit</a>
...
Délai : 2 à 3 jours • Tarif : 32-45€/m²
...
<div class="cta-box" style="background: linear-gradient(135deg, #059669 0%, #047857 100%); color: white; padding: 2rem; border-radius: 16px; margin: 2rem 0; text-align: center; box-shadow: 0 8px 16px rgba(5,150,105,0.3);">
  ...
  <a href="https://wa.me/33757821306?text=Bonjour,%20je%20souhaite%20une%20estimation%20pour%20r%C3%A9parer%20mon%20parquet%20avant%20l%27%C3%A9tat%20des%20lieux" style="display: inline-block; background: #25D366; color: white; padding: 1rem 2.5rem; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 1.1rem; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">📲 Envoyer mes photos sur WhatsApp</a>
  <p style="margin-top: 1rem; font-size: 0.9rem; opacity: 0.8;">Ou appelez directement : ☎️ 07 57 82 13 06</p>
</div>

### 🎓 Témoignages de locataires ayant évité la retenue
...
| Volume annuel | Remise | Tarif ponçage + vitrif. |
|---------------|--------|-------------------------|
| 5 à 10 chantiers/an | -10% | 29-40 €/m² |
| 11 à 20 chantiers/an | -15% | 27-38 €/m² |
| + de 20 chantiers/an | -20% | 26-36 €/m² |
...
<div class="cta-box" style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); color: white; padding: 2rem; border-radius: 16px; margin: 2rem 0; text-align: center; box-shadow: 0 8px 16px rgba(220,38,38,0.3);">
  ...
  <a href="tel:+33757821306" style="display: inline-block; background: white; color: #dc2626; padding: 1rem 2.5rem; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 1.1rem; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">📞 Demander un devis groupé</a>
...
## 🛠️ Outil gratuit : Calculateur de coûts

<div style="background: #f8fafc; padding: 2.5rem; border-radius: 16px; margin: 2rem 0; border: 2px solid #e2e8f0;">
  <h3 style="font-size: 1.5rem; margin-bottom: 1.5rem; color: #1e293b; text-align: center;">💰 Estimez votre budget en 30 secondes</h3>
  ...
  <div style="max-width: 600px; margin: 0 auto; background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    <form id="calculateur-form">
      <div style="margin-bottom: 1.5rem;">
        <label style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #374151;">Type de dégâts :</label>
        <select name="degat" id="degat-select" style="width: 100%; padding: 0.75rem; border: 2px solid #e5e7eb; border-radius: 8px; font-size: 1rem; background: white;">
          <option value="rayures">Rayures légères</option>
          <option value="taches">Taches (urine, goudron, graisse)</option>
          <option value="gondolage">Gondolage / humidité</option>
          <option value="brulures">Brûlures ou trous</option>
        </select>
      </div>

      <div style="margin-bottom: 1.5rem;">
        <label style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #374151;">Surface (m²) :</label>
        <input type="number" name="surface" id="surface-input" placeholder="Ex: 20" min="1" max="500" required style="width: 100%; padding: 0.75rem; border: 2px solid #e5e7eb; border-radius: 8px; font-size: 1rem;">
      </div>

      <button type="button" onclick="calculerBudget()" style="width: 100%; background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: white; padding: 1rem; border: none; border-radius: 12px; font-size: 1.1rem; font-weight: 700; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.transform=''scale(1.02)''" onmouseout="this.style.transform=''scale(1)''">
        🧮 Calculer mon budget
      </button>
    </form>

    <div id="resultat-calculateur" style="display: none; margin-top: 2rem; padding: 1.5rem; background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border-radius: 12px; border: 2px solid #0ea5e9; text-align: center;">
      <p style="font-size: 0.9rem; color: #64748b; margin-bottom: 0.5rem; font-weight: 600;">BUDGET ESTIMÉ</p>
      <p style="font-size: 2.5rem; font-weight: 700; color: #0c4a6e; margin: 0.5rem 0;" id="prix-estime">0 €</p>
      <p style="font-size: 0.85rem; color: #64748b; margin-bottom: 1rem;">TVA incluse • Hors déplacement</p>
      <p style="font-size: 0.9rem; color: #334155; margin-bottom: 1.5rem;" id="detail-calcul"></p>
      <a href="tel:+33757821306" style="display: inline-block; background: #2563eb; color: white; padding: 0.75rem 2rem; border-radius: 8px; text-decoration: none; font-weight: 600;">📞 Obtenir un devis précis</a>
    </div>

    <p style="margin-top: 1.5rem; font-size: 0.85rem; color: #64748b; text-align: center;">ℹ️ Cette estimation est indicative. Pour un devis personnalisé gratuit, contactez-nous.</p>
  </div>
</div>

<script>
  function calculerBudget() {
    const degat = document.getElementById(''degat-select'').value;
    const surface = parseInt(document.getElementById(''surface-input'').value);

    if (!surface || surface < 1) {
      alert(''Veuillez entrer une surface valide (minimum 1 m²)'');
      return;
    }
    ...
    // Tarifs basés sur la grille tarifaire 2024
    if (degat === ''rayures'') {
      prixM2 = 35; // Ponçage + vitrification basique
      typeIntervention = ''Ponçage + vitrification (35 €/m²)'';
    } else if (degat === ''taches'') {
      prixM2 = 50; // Décapage + traitement spécifique
      typeIntervention = ''Décapage + traitement spécifique (50 €/m²)'';
    } else if (degat === ''gondolage'') {
      prixM2 = 60; // Rénovation lourde
      typeIntervention = ''Rénovation lourde (60 €/m²)'';
    } else if (degat === ''brulures'') {
      prixM2 = 80; // Remplacement de lames
      typeIntervention = ''Remplacement de lames (80 €/m²)'';
    }

    const total = prixM2 * surface;

    document.getElementById(''prix-estime'').textContent = total.toLocaleString(''fr-FR'') + '' €'';
    document.getElementById(''detail-calcul'').textContent = `${surface} m² × ${prixM2} €/m² = ${total} €`;
    document.getElementById(''resultat-calculateur'').style.display = ''block'';

    // Scroll vers le résultat
    document.getElementById(''resultat-calculateur'').scrollIntoView({ behavior: ''smooth'', block: ''nearest'' });
  }
...
**Besoin d''un devis pour votre projet de rénovation de parquet ?**

📞 [07 57 82 13 06](tel:+33757821306) • 📲 [WhatsApp](https://wa.me/33757821306)

*Intervention rapide en Alsace : Strasbourg, Colmar, Mulhouse, Haguenau, Sélestat, Saverne...*
',
  updated_at = NOW()
